...
@GenerateMocks([], customMocks: [
  ...
  MockSpec<ForecastService>(onMissingStub: OnMissingStub.returnDefault),
...
MockForecastService getAndRegisterForecastService() {
  _removeRegistrationIfExists<ForecastService>();
  final service = MockForecastService();
  locator.registerSingleton<ForecastService>(service);
  return service;
}
